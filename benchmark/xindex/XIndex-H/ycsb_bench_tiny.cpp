...
size_t iteration = 1;
#ifdef MTTM
size_t operate_cnt = 200000000;
size_t key_cnt = 50000000;
#else
size_t operate_cnt = 1000000000;
size_t key_cnt = 250000000;
#endif
...
#ifdef MTTM
  load_ycsb_data("/home/cjlee/CXL-emulation.code/workloads/YCSB/mttm_dat/load_tiny.dat");
  load_ycsb_transaction("/home/cjlee/CXL-emulation.code/workloads/YCSB/mttm_dat/transaction_tiny.dat");
#else
  load_ycsb_data("/home/cjlee/CXL-emulation.code/workloads/YCSB/load.dat");
  load_ycsb_transaction("/home/cjlee/CXL-emulation.code/workloads/YCSB/transaction.dat");
#endif
  xindex_t *tab_hi;
